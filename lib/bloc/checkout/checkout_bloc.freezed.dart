...
mixin _$CheckoutEvent {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(double tax) addTax,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(double tax)? addTax,
...
abstract class _AddTax implements CheckoutEvent {
  const factory _AddTax(final double tax) = _$AddTaxImpl;
...
mixin _$CheckoutState {
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<ProductQuantity> items, Discount? discount,
            double tax, int serviceCharge)?
        checkoutSuccess,
...
class _$CheckoutSuccessImpl implements _CheckoutSuccess {
  const _$CheckoutSuccessImpl(final List<ProductQuantity> items, this.discount,
      this.tax, this.serviceCharge)
      : _items = items;
  ...
  @override
  String toString() {
    return 'CheckoutState.checkoutSuccess(items: $items, discount: $discount, tax: $tax, serviceCharge: $serviceCharge)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return checkoutSuccess(items, discount, tax, serviceCharge);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return checkoutSuccess?.call(items, discount, tax, serviceCharge);
  }
...
abstract class _CheckoutSuccess implements CheckoutState {
  const factory _CheckoutSuccess(
      final List<ProductQuantity> items,
      final Discount? discount,
      final double tax,
      final int serviceCharge) = _$CheckoutSuccessImpl;
